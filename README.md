...
## المصادقة واستعادة الوصول

صفحة الدخول تعرض رمز خطأ Firebase المناسب عند فشل المصادقة، وتوفر خيار إرسال رابط إعادة تعيين كلمة المرور إلى البريد. تغيير كلمة المرور من الإعدادات يتطلب إعادة التحقق من كلمة المرور الحالية، وتُرفض الكلمات الجديدة التي تقل عن 8 أحرف قبل استدعاء Firebase.
